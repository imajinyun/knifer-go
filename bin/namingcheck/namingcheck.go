...
func allowedTrustBoundaryName(fn funcDecl) bool {
	...
	allowedPackages := map[string]bool{
		"vhttp": true, "vresty": true, "vurl": true, "vconf": true, "vfile": true, "vdb": true,
		"http": true, "resty": true, "url": true, "conf": true, "file": true, "db": true, "shared": true,
	}
	if allowedPackages[fn.Package] {
		return true
	}
	allowedNames := map[string]bool{
		"CheckedConvert": true,
	}
	return allowedNames[fn.Name]
}
