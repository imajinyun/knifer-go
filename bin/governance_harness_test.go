...
func (f *governanceFixture) RunDynamicContractsCheck() (string, error) {
	f.t.Helper()
	return f.RunGoTool("dynamiccontractscheck", "-root", f.root)
}

func (f *governanceFixture) RunDynamicContractsCheckJSON() (string, error) {
	f.t.Helper()
...
func (f *governanceFixture) RunAPIConvergenceCheck() (string, error) {
	f.t.Helper()
	return f.RunGoTool("apiconvergencecheck", "-root", f.root)
}

func (f *governanceFixture) RunAPIConvergenceCheckJSON() (string, error) {
	f.t.Helper()
...
func (f *governanceFixture) RunCapabilityDomainsCheck() (string, error) {
	f.t.Helper()
	return f.RunGoTool("capabilitydomainscheck", "-root", f.root)
}

func (f *governanceFixture) RunCapabilityDomainsCheckJSON() (string, error) {
	f.t.Helper()
	return f.RunGoTool("capabilitydomainscheck", "-root", f.root, "-json")
}

func (f *governanceFixture) RunRoadmapCatalogCheck() (string, error) {
	f.t.Helper()
	return f.RunGoTool("roadmapcatalogcheck", "-root", f.root)
}

func (f *governanceFixture) RunRoadmapCatalogCheckJSON() (string, error) {
	f.t.Helper()
	return f.RunGoTool("roadmapcatalogcheck", "-root", f.root, "-json")
}
...
func (f *governanceFixture) RunGovernanceMigrationCheckJSON() (string, error) {
	f.t.Helper()
	return f.RunGoTool("governancemigrationcheck", "-root", f.root, "-json")
}
...
func (f *governanceFixture) RunBenchmarkRegressionCheckJSON() (string, error) {
	f.t.Helper()
	return f.RunGoTool("benchmarkregressioncheck", "-root", f.root, "-json")
}
