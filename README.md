...
| Produce image thumbnails, convert PNG/JPEG/GIF, read metadata, generate QR/barcodes, decode QR/barcodes, or generate graphical captchas | [`vimg`](docs/doc/21-vimg.md) |
...
| [`vimg`](docs/doc/21-vimg.md) | `github.com/imajinyun/go-knifer/vimg` | Image helpers: proportional thumbnails, PNG/JPEG/GIF conversion, metadata introspection, ZXing-backed QR/barcode generation and decoding, PNG/SVG/ASCII/Base64 data URI output, QR logo embedding, transparent backgrounds, and line/circle/shear/GIF captcha generation. |
